...
<?php
    ...
    if ($status) {
        while ($row = mysqli_fetch_assoc($status)) {
            ...
            echo '<b>Status:</b>' . $row['Status'] . '<br><br><br><br>';
        }
    }
?>

<input class="btn btn-primary waves-effect" name="submit" align="center" type="submit" value="BACK" formaction="./holiday_view.php">
</section>
</form>
