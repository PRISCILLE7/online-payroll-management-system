        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <h2 class="card-inside-title">Leave Reject Reason Description:</h2>
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                ...
                                <center>
                                    ...
                                    <input type="submit" name="close" class="btn btn-primary waves-effect" value="CLOSE" formaction="./Accept_Reject_hr.php">
