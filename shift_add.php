...
$q = "INSERT INTO shift (`Shift_name`, `In_time`, `Out_time`, `Created_date`, `Modified_date`, `Status`) 
      VALUES ('".$shiftname."','".$shiftintime."','".$shiftouttime."','".$createddate."','".$modifieddate."','".$status."')";
